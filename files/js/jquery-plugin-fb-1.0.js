/**
 * @author Dark Karrel - darkkarrel@gmail.com
 * @version v.1.0.0
 * @since 2013060
 * This plugin render normal checkbox and radio box with style image.
 * It allow user to use tab to navigate between input. 
 */
